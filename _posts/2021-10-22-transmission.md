...
layout: redirected
sitemap: false
redirect_to: https://creio.ctlos.ru/posts/transmission/
...
Описание всех настроек [settings.json](https://pcminipro.ru/os/nastrojka-transmission-daemon-settings-json/).
